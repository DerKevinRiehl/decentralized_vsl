...
SHARE_COMPLIANT = 0.5  # [%] how many of the connected vehicles comply with control
...
for it_time in range(0, SIMULATION_TIME):
    ...
    # time.sleep(0.01)
    # Spawn Vehicles
    vehicle_counter, current_vehicle_infos = spawnProcedure(DEMAND_PROFILE(it_time), vehicle_counter, current_vehicle_infos)
