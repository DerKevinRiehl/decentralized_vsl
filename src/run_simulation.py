...
def spawnProcedure(flow_per_route, vehicle_counter, vehicle_infos):
...
SHARE_CONNECTED = 1.0  # [%] how many of vehicles are connected via DSRC
...
SHALL_EXECUTE_CONTROL = True # turn on/off control law for compliant vehicles
...
# sumo_binary_path = "C:/Users/kriehl/AppData/Local/sumo-1.19.0/bin/sumo-gui.exe"
sumo_config_file = "sumo_map/Configuration.sumocfg" 
...
for it_time in range(0, SIMULATION_TIME):
    # time.sleep(0.01)
    # Spawn Vehicles
    vehicle_counter, current_vehicle_infos = spawnProcedure(SPAWN_FLOW_PER_ROUTE, vehicle_counter, current_vehicle_infos)
